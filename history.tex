...
\noindent
\begin{description}
    \item [2026年度版 (2026年9月)] \mbox{}
       \begin{itemize}
           \item C言語の入力値の検証と、配列・動的メモリの安全な扱いに関する説明を改善
           \item SSH公開鍵認証の説明をより正確に
           \item \LaTeX の誤記・説明・サンプルコードを修正
           \item その他、年度表記の更新、各種コマンドや技術的記述の修正、表記の統一を実施
       \end{itemize}


    \item [2025年度版 (2025年9月)] \mbox{}
