...
\begin{commandline2}
    \prompt \underline{ssh remote.phys.s.u-tokyo.ac.jp -l \textit{username}}
\end{commandline2} \noindent
あるいは
\begin{commandline2}
