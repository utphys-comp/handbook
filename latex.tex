...
\noindent{\bf \large 1.1 \ C 言語の歴史} \\[.2em]
...
\noindent{\bf \large 1.2 \ C 言語の特徴} \\[.2em]

この節では C 言語の特徴について述べよう。 \\[.2em]

\noindent{\bf 1.2.1 構造化プログラミング言語} \\[.2em]

C 言語にはデータのまとまりを表す構造体と呼ばれるデータ型がある。
データを集合として扱う構造データ型は FORTRAN にはなかった。\\
\dots \\[.2em]

\noindent{\bf 1.2.2 機械指向型プログラミング言語} \\[.2em]
...
\noindent{\bf \Large 2 \ FORTRAN} \\[.2em]
